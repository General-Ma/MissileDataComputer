...
class MissileLauncher(models.Model):
    #--------------------------------------------------------------------------------------------
    #   MissileLauncher is a platform that can carry and launch missiles
    ...
    #   contact: Why do you will need to use email to issue a missile launch order? Work Life Balance!
    #   commander: the name of the commander who is in charge of operating this MissileLauncher
    #---------------------------------------------------------------------------------------------
